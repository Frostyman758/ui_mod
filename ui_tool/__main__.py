...
from . import pathmap, strcodemap, uigb, uilb
...
def _cmd_convert(args: argparse.Namespace) -> None:
    ...
    if fmt == 'uilb':
        ...
        strcode_mapping = strcodemap.load_default_mapping()
        uigb.convert_gz_to_tpp(input_path, output_path, mapping, strcode_mapping)
    else:
        raise ValueError(f"Unsupported format '{fmt}'")
